...
<body>
	...
	<script>
		...
		var message = '클릭한 위치의 중심은 ' + latLngCenter.getLat() + ' & ' + latLngCenter.getLng() + ' 입니다<br>';    
 ...
 */		
		...
		function getListItem(index, places) {
		    ...
		    if (places.road_address_name) {
		      ...
		      itemStr += '  <span class="tel">' + "전화번호&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;" + places.phone  + '</span>' +
		                '</div>';           
		
		    el.innerHTML = itemStr;
		    $('#placesList').css('width', '300px').css('padding', '20px');
		    el.className = 'item';
